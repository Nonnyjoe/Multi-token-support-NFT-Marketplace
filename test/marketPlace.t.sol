...
contract MarketFacetTest is Test {
    MarketplaceFacet marketFacet;
    MockNFT mockNFT;
    IERC20 Usdt;
    ...
    function setUp() public {
        marketFacet = new MarketplaceFacet();
        mockNFT = new MockNFT();
    ...
    function testPurchaseViaLink() public {
        uint ItemId = testCreateAuction();
        ...
        marketFacet.PurchaseViaLink(ItemId);
        vm.stopPrank();
    }

    function testPurchaseViaBTC() public {
        uint ItemId = testCreateAuction();
        ...
        marketFacet.PurchaseViaBTC(ItemId);
        vm.stopPrank();
    }
